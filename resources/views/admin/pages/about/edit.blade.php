<x-admin-app-layout :title="'About Edit'">
    ...
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Edit About In Site</h6>
        <hr />
                ...
                <form action="{{ route('admin.about.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-lg-12 mb-3">
                            ...
                            <textarea name="short_descp" id="" cols="3" rows="3" class="form-control">{{ old('short_descp', $item->short_descp) }}</textarea>
                        </div>

                        <div class="col-6 col-lg-12 mb-3">
                            <label for="" class="mb-2">Long Description</label>
                            <textarea name="long_descp" id="" class="form-control editor">{!! old('long_descp', $item->long_descp) !!}</textarea>
                        </div>
                        ...
                        <div class="col-6 col-lg-2 mb-3">
                            <label for="" class="mb-2">Current Image One</label>
                            <div>
                        ...
                        <div class="col-6 col-lg-2 mb-3">
                            <label for="" class="mb-2">Current Image Two</label>
                            <div>
