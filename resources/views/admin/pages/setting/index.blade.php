                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <select name="maintenance_mode" class="form-select">
                                ...
                                <option value="1" {{ optional($setting->first())->maintenance_mode == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ optional($setting->first())->maintenance_mode == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
