<x-admin-app-layout :title="'Testimonial'">
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.testimonial.index') }}" class="btn btn-dark rounded-0 px-3">Back To List
                    </a>
                </div>
            </div>
        </div>
        ...
        <h6 class="mb-0 text-uppercase">Edit Testimonial In Site</h6>
        <hr />
                ...
                <form action="{{ route('admin.testimonial.update',$item->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-3 mb-3">
                            ...
                            <input type="number" min="1" max="5" class="form-control" required placeholder="Rating" name="rating"
                        ...
                        <div class="col-12 col-lg-12 mb-3">
                            <button type="submit" class="btn btn-outline-primary rounded-0 px-3 float-end">Update Data
                                </button>
                        </div>
